 ...
 */
export declare function HasManyField(args: () => {
 ...
 * @param localKey The local key on the parent model
 */
export declare function HasOneField(args: () => {
    related: typeof Model | string;
    foreignKey: string;
    localKey?: string;
}): (target: Object, propertyName: string | symbol) => void;
 ...
 */
export declare function BelongsToField(args: () => {
    parent: typeof Model | string;
    foreignKey: string;
    ownerKey?: string;
}): (target: Object, propertyName: string | symbol) => void;
export declare function HasManyByField(args: () => {
    parent: typeof Model | string;
    foreignKey: string;
    ownerKey?: string;
}): (target: Object, propertyName: string | symbol) => void;
export declare function HasManyThroughField(args: () => {
    related: typeof Model | string;
...
export declare function BelongsToManyField(args: () => {
    related: typeof Model | string;
...
export declare function MorphToField(args: () => {
    id: string;
    type: string;
}): (target: Object, propertyName: string | symbol) => void;
export declare function MorphOneField(args: () => {
    related: typeof Model | string;
    id: string;
    type: string;
    localKey?: string;
}): (target: Object, propertyName: string | symbol) => void;
export declare function MorphManyField(args: () => {
    related: typeof Model | string;
    id: string;
    type: string;
    localKey?: string;
}): (target: Object, propertyName: string | symbol) => void;
export declare function MorphToManyField(args: () => {
    related: typeof Model | string;
    pivot: typeof Model | string;
    relatedId: string;
    id: string;
...
export declare function MorphedByManyField(args: () => {
    related: typeof Model | string;
    pivot: typeof Model | string;
    relatedId: string;
    id: string;
